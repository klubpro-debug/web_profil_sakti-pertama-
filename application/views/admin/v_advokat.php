                ...
                <tbody>
          				<?php
          					...
          					foreach ($data->result_array() as $i) :
          					   ...
          					   $nip=$i['advokat_nip'];
          					   $nama=$i['advokat_nama'];
          					   $jenkel=$i['advokat_jenkel'];
          					   $tmp_lahir=$i['advokat_tmp_lahir'];
          					   $tgl_lahir=$i['advokat_tgl_lahir'];
                       $ahli=$i['advokat_ahli'];
                       $photo=$i['advokat_photo'];
                    ...
                    <div class="modal-body">
                                ...
                                <input type="hidden" value="<?php echo $photo;?>" name="gambar">
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">NIA</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xnip" value="<?php echo $nip;?>" class="form-control" id="inputUserName" placeholder="NIA" required>
                                        </div>
                                    </div>
